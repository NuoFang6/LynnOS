...
# #
# # BBRv3
# cp -rf $lynndir/patch/bbrv3/* ./
# # 添加自定义 nft 规则页面
# patch -p1 <$lynndir/patch/fw4/100-openwrt-firewall4-add-custom-nft-command-support.patch
# #
# pushd ./feeds/luci
# patch -p1 <$lynndir/patch/fw4/04-luci-add-firewall4-nft-rules-file.patch
# popd
...
# cp -rf $lynndir/patch/target/991-arm64-dts-rockchip-add-more-cpu-operating-points-for.patch ./target/linux/rockchip/patches-6.6/
