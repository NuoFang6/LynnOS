...
#
# 填写抓取到的网址
URL='http://10.31.0.10:801/eportal/portal/login?callback=dr1003&login_method=1&user_account=233051042%40telecom&user_password=190012'
# 登录成功时会出现的唯一关键词
...
login() {
    ...
    if echo "$content" | grep -qF $SUCCESS_WORD
    then
        return 0
    fi
